...
library.document = (summary, res) => {
    ...
    var documentPdf = {
        ...
        content: [
            ...
            { margin: [50, 0, 0, 0], fontSize: 16, text: 'วิธีการรักษา : ' }, dialog.printTreatment(summary.treatment),
            { margin: [50, 5, 0, 0], fontSize: 16, text: 'ช่วงเวลาการรักษา :' }, { margin: [150, -20, 0, 0], fontSize: 16, text: summary.statusTime },
            { margin: [50, 0, 0, 0], fontSize: 16, text: 'จ่ายยา :' }, dialog.printDrug(summary.countDrugs),
