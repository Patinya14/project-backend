...
library.document =async (certificate , res) => {
    ...
    var documentPdf = {
        ...
        content: [
            ...
            { margin: 10, text: '' },
            { fontSize: 15, text: 'ข้าพเจ้า' }, { margin: [40, -20, 0, 0], fontSize: 15, text: certificate[0].treater.treNameTitle + certificate[0].treater.trePhysicianName + ' ' + certificate[0].treater.trePhysicianSurName },
            { fontSize: 15, text: 'ใบอนุญาตประกอบโรคศิลปะสาขาการแพทย์แผนไทยประยุกต์เลขที่' }, { margin: [270, -19, 0, 0], fontSize: 15, text: certificate[0].treater.treLicensed_No },
            { fontSize: 15, text: 'ได้ทำการตรวจร่างกาย' }, { margin: [100, -19, 0, 0], fontSize: 15, text: certificate[0].personal.personNameTitle + certificate[0].personal.personName + ' ' + certificate[0].personal.personSurname },
            { fontSize: 15, text: 'ที่อยู่ปัจจุบัน' }, { margin: [60, -19, 0, 0], fontSize: 15, text: certificate[0].personal.personAddress },
            { fontSize: 15, text: 'เมื่อวันที่' }, { margin: [50, -19, 0, 0], fontSize: 15, text: cer.showDate(certificate[0].date) },
            { fontSize: 15, text: 'ได้พิจารณาเห็นแล้วว่า ...................................................................................................' },
            '..........................................................................................................................................................................',
            { fontSize: 15, text: 'มีอาการ/โรค' }, { margin: [60, -20, 0, 0], fontSize: 15, text: certificate[0].cerSymptom },
